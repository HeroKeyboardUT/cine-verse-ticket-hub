...
const Footer = () => {
  return (
    <footer className="bg-black/50 text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="mt-2 text-sm">
              Your ultimate destination for movies and cinema tickets.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>Email: contact@cineverse.com</li>
              <li>Phone: +1 (123) 456-7890</li>
              <li>Address: 123 Cinema St, Movie City</li>
            </ul>
          </div>
        </div>
